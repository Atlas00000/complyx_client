...
/**
 * ComplianceMatrixContainer Component
 * 
 ...
 * - Smooth transitions
 */
export default function ComplianceMatrixContainer({ 
  children, 
  className = '' 
}: ComplianceMatrixContainerProps) {
  return (
    <motion.div
    ...
    >
      ...
      <motion.div
        className="absolute top-1/4 right-1/4 w-96 h-96 bg-primary/15 dark:bg-primary/25 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      <motion.div
        className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent/15 dark:bg-accent/25 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
